...
local Main = game:GetService("Players").LocalPlayer.PlayerGui

if Main:FindFirstChild("GameGUI") and Main:FindFirstChild("GameGUI"):FindFirstChild("Crouch") then
	
	Main:FindFirstChild("GameGUI"):FindFirstChild("Crouch"):Destroy()
	...
	Crouch.Name = "Crouch"
	Crouch.Parent = Main:FindFirstChild("GameGUI")
